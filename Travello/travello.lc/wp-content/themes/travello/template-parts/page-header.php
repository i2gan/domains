...
<?php if ( is_page( 8 ) ) {
	$style = 'about';
	$page_style = 'about_responsive';
} elseif ( is_page( 12 ) ) {
	$style = 'news';
	$page_style = 'news_responsive';
} ?>
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/styles/<?php echo $style; ?>.css">
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/styles/<?php echo $page_style ?>.css">
<?php wp_head(); ?>
</head>
<body>
...
?>
							...
							<div class="header_phone ml-auto">Call us: <?php echo get_option( 'my_phone' ); ?></div>
