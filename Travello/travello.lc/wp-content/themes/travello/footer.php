...
<script src="<?php bloginfo('template_url'); ?>/plugins/Isotope/isotope.pkgd.min.js"></script>
<script src="<?php bloginfo('template_url'); ?>/plugins/scrollTo/jquery.scrollTo.min.js"></script>
